...
options.OptimalityTolerance=1e-10;
 [p,fval,exitflag,output]=fminsearch(@(q)res(q,Data),q0) 
 %p will be the optimal parameters, l is the value for the function we are minimizing 0.5||....||^2.
...
Yla=280*(1+Y(indx:Dn,1));
  %For fminsearch
F=sum((Data(208:267)-Yla)).^2;%or (norm(Data-Yla))^2
